...
[![Tests](https://img.shields.io/github/workflow/status/graph-data-structure/adjacency-list/ci:test?event=push&label=tests)](https://github.com/graph-data-structure/adjacency-list/actions/workflows/ci:test.yml?query=branch:main)
